...
class Annotation(AuthoredEntity, DateStampedEntity):
    ...
    annotation_ingest_id: Optional[str] = Field(default=None, description="""A unique identifier for grouping annotation sources during ingestion.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Annotation', 'AnnotationMetadata']} })
