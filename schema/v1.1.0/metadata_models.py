...
class Tomogram(AuthoredEntity):
    ...
    affine_transformation_matrix: Optional[Any] = Field(None, description="""A placeholder for any type of data.""", json_schema_extra = { "linkml_meta": {'alias': 'affine_transformation_matrix', 'domain_of': ['Tomogram']} })
