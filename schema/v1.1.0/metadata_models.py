...
class PicturePath(ConfiguredBaseModel):
    ...
    """
    snapshot: str = Field(..., description="""Path to the dataset preview image relative to the dataset directory root.""")
    thumbnail: str = Field(..., description="""Path to the thumbnail of preview image relative to the dataset directory root.""")
...
class TiltSeries(ConfiguredBaseModel):
    ...
    is_aligned: Optional[bool] = Field(False, description="""Whether this tilt series is aligned""")
...
class Tomogram(AuthoredEntity):
    ...
    tomogram_version: Optional[float] = Field(None, description="""Version of tomogram""")
...
class AnnotationOrientedPointFile(AnnotationSourceFile):
    ...
    """
    binning: Optional[int] = Field(1, description="""The binning factor for a point / oriented point / instance segmentation annotation file.""")
    ...
    order: Optional[str] = Field(None, description="""The order of axes for an oriented point / instance segmentation annotation file.""")
