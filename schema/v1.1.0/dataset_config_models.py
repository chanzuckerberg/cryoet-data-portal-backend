...
class Container(ConfiguredBaseModel):
    ...
    """
    annotations: Optional[List[AnnotationEntity]] = Field(default_factory=list, description="""An annotation entity.""")
    dataset_keyphotos: Optional[List[DatasetKeyPhotoEntity]] = Field(default_factory=list, description="""A dataset key photo entity.""")
    datasets: List[DatasetEntity] = Field(default_factory=list, description="""A dataset entity.""")
    deposition_keyphotos: Optional[List[DepositionKeyPhotoEntity]] = Field(default_factory=list, description="""A deposition key photo entity.""")
    depositions: List[DepositionEntity] = Field(default_factory=list, description="""A deposition entity.""")
    frames: Optional[List[FrameEntity]] = Field(default_factory=list, description="""A frame entity.""")
    gains: Optional[List[GainEntity]] = Field(default_factory=list, description="""A gain entity.""")
    key_images: Optional[List[KeyImageEntity]] = Field(default_factory=list, description="""A key image entity.""")
    rawtilts: Optional[List[RawTiltEntity]] = Field(default_factory=list, description="""A raw tilt entity.""")
    runs: Optional[List[RunEntity]] = Field(default_factory=list, description="""A run entity.""")
    standardization_config: StandardizationConfig = Field(..., description="""A standardization configuration.""")
    tiltseries: Optional[List[TiltSeriesEntity]] = Field(default_factory=list, description="""A tilt series entity.""")
    tomograms: Optional[List[TomogramEntity]] = Field(default_factory=list, description="""A tomogram entity.""")
    voxel_spacings: List[VoxelSpacingEntity] = Field(default_factory=list, description="""A voxel spacing entity.""")
...
class DefaultSource(ConfiguredBaseModel):
    ...
    """
    destination_glob: Optional[DestinationGlob] = Field(None, description="""A glob class for finding files in the output / destination directory.""")
    source_glob: Optional[SourceGlob] = Field(None, description="""A glob class for finding files in the source directory.""")
    source_multi_glob: Optional[SourceMultiGlob] = Field(None, description="""A glob class for finding files in the source directory (with multiple globs).""")
...
class SourceParentFilters(ConfiguredBaseModel):
    ...
    """
    include: Optional[SourceParent] = Field(None, description="""A filter for a parent class of a source. For a given attribute, it can only be used if the current class is a subclass of the attribute.""")
    exclude: Optional[SourceParent] = Field(None, description="""A filter for a parent class of a source. For a given attribute, it can only be used if the current class is a subclass of the attribute.""")
...
class SourceParent(ConfiguredBaseModel):
    ...
    voxel_spacing: Optional[List[str]] = Field(default_factory=list, description="""Include or exclude voxel spacings.""")
...
class DefaultLiteral(ConfiguredBaseModel):
    ...
    """
    value: List[Any] = Field(default_factory=list, description="""A placeholder for any type of data.""")
...
class KeyPhotoEntity(ConfiguredBaseModel):
    ...
    A key photo entity.
    """
    sources: List[KeyPhotoSource] = Field(default_factory=list, description="""A key photo source.""")
...
class KeyPhotoSource(SourceParentFiltersEntity):
    ...
    A key photo source.
    """
    literal: Optional[KeyPhotoLiteral] = Field(None, description="""A literal for a key photo.""")
    parent_filters: Optional[SourceParentFilters] = Field(None, description="""Filters for the parent of a source.""")
...
class KeyPhotoLiteral(ConfiguredBaseModel):
    ...
    """
    value: PicturePath = Field(..., description="""A set of paths to representative images of a piece of data.""")
...
class AnnotationEntity(ConfiguredBaseModel):
    ...
    """
    metadata: Annotation = Field(..., description="""Metadata describing an annotation.""")
    sources: List[AnnotationSource] = Field(default_factory=list, description="""An annotation source.""")
...
class AnnotationSource(ConfiguredBaseModel):
    ...
    """
    InstanceSegmentation: Optional[AnnotationInstanceSegmentationFile] = Field(None, description="""File and sourcing data for an instance segmentation annotation. Annotation that identifies individual instances of object shapes.""")
    OrientedPoint: Optional[AnnotationOrientedPointFile] = Field(None, description="""File and sourcing data for an oriented point annotation. Annotation that identifies points along with orientation in the volume.""")
    Point: Optional[AnnotationPointFile] = Field(None, description="""File and sourcing data for a point annotation. Annotation that identifies points in the volume.""")
    SegmentationMask: Optional[AnnotationSegmentationMaskFile] = Field(None, description="""File and sourcing data for a segmentation mask annotation. Annotation that identifies an object.""")
    SemanticSegmentationMask: Optional[AnnotationSemanticSegmentationMaskFile] = Field(None, description="""File and sourcing data for a semantic segmentation mask annotation. Annotation that identifies classes of objects.""")
    parent_filters: Optional[SourceParentFilters] = Field(None, description="""Filters for the parent of a source.""")
...
class DatasetEntity(ConfiguredBaseModel):
    ...
    A dataset entity.
    """
    metadata: Dataset = Field(..., description="""High-level description of a cryoET dataset.""")
    sources: List[DatasetSource] = Field(default_factory=list, description="""A dataset source.""")
...
class DepositionEntity(ConfiguredBaseModel):
    ...
    A deposition entity.
    """
    metadata: Deposition = Field(..., description="""Metadata describing a deposition.""")
    sources: List[DepositionSource] = Field(default_factory=list, description="""A deposition source.""")
...
class FrameEntity(ConfiguredBaseModel):
    ...
    A frame entity.
    """
    sources: List[FrameSource] = Field(default_factory=list, description="""A frame source.""")
...
class GainEntity(ConfiguredBaseModel):
    ...
    A gain entity.
    """
    sources: List[GainSource] = Field(default_factory=list, description="""A gain source.""")
...
class KeyImageEntity(ConfiguredBaseModel):
    ...
    A key image entity.
    """
    sources: List[KeyImageSource] = Field(default_factory=list, description="""A key image source.""")
...
class RawTiltEntity(ConfiguredBaseModel):
    ...
    A raw tilt entity.
    """
    sources: List[RawTiltSource] = Field(default_factory=list, description="""A raw tilt source.""")
...
class RunEntity(ConfiguredBaseModel):
    ...
    A run entity.
    """
    sources: List[RunSource] = Field(default_factory=list, description="""A run source.""")
...
class TiltSeriesEntity(ConfiguredBaseModel):
    ...
    """
    metadata: TiltSeries = Field(..., description="""Metadata describing a tilt series.""")
    sources: List[TiltSeriesSource] = Field(default_factory=list, description="""A tilt series source.""")
...
class TomogramEntity(ConfiguredBaseModel):
    ...
    A tomogram entity.
    """
    metadata: Tomogram = Field(..., description="""Metadata describing a tomogram.""")
    sources: List[TomogramSource] = Field(default_factory=list, description="""A tomogram source.""")
...
class VoxelSpacingEntity(ConfiguredBaseModel):
    ...
    """
    sources: List[VoxelSpacingSource] = Field(default_factory=list, description="""A voxel spacing source.""")
...
class VoxelSpacingSource(SourceParentFiltersEntity):
    ...
    destination_glob: Optional[DestinationGlob] = Field(None, description="""A glob class for finding files in the output / destination directory.""")
    source_glob: Optional[SourceGlob] = Field(None, description="""A glob class for finding files in the source directory.""")
    literal: Optional[VoxelSpacingLiteral] = Field(None, description="""A literal for a voxel spacing.""")
    tomogram_header: Optional[TomogramHeader] = Field(None, description="""A tomogram header, a unique source attribute for voxel spacing.""")
    parent_filters: Optional[SourceParentFilters] = Field(None, description="""Filters for the parent of a source.""")
