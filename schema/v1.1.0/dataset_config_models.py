...
linkml_meta = LinkMLMeta({'default_prefix': 'cdp-dataset-config/',
...
class FundedEntity(ConfiguredBaseModel):
    ...
    funding: Optional[List[FundingDetails]] = Field(default_factory=list, description="""A funding source for a scientific data entity (base for JSON and DB representation).""", json_schema_extra = { "linkml_meta": {'alias': 'funding',
...
class CrossReferencedEntity(ConfiguredBaseModel):
    ...
    cross_references: Optional[CrossReferencesEntity] = Field(None, description="""A set of cross-references to other databases and publications.""", json_schema_extra = { "linkml_meta": {'alias': 'cross_references',
...
class ExperimentalMetadata(ConfiguredBaseModel):
    ...
    other_setup: Optional[str] = Field(None, description="""Describes other setup not covered by sample preparation or grid preparation that may make this dataset unique in the same publication.""", json_schema_extra = { "linkml_meta": {'alias': 'other_setup',
         ...
         'recommended': True} })
    organism: Optional[OrganismDetails] = Field(None, description="""The species from which the sample was derived.""", json_schema_extra = { "linkml_meta": {'alias': 'organism', 'domain_of': ['ExperimentalMetadata', 'Dataset']} })
    tissue: Optional[TissueDetails] = Field(None, description="""The type of tissue from which the sample was derived.""", json_schema_extra = { "linkml_meta": {'alias': 'tissue', 'domain_of': ['ExperimentalMetadata', 'Dataset']} })
    ...
    cell_strain: Optional[CellStrain] = Field(None, description="""The strain or cell line from which the sample was derived.""", json_schema_extra = { "linkml_meta": {'alias': 'cell_strain', 'domain_of': ['ExperimentalMetadata', 'Dataset']} })
    cell_component: Optional[CellComponent] = Field(None, description="""The cellular component from which the sample was derived.""", json_schema_extra = { "linkml_meta": {'alias': 'cell_component', 'domain_of': ['ExperimentalMetadata', 'Dataset']} })
...
class Deposition(CrossReferencedEntity, AuthoredEntity, DatestampedEntity):
    ...
    deposition_types: List[DepositionTypesEnum] = Field(default_factory=list, description="""Type of data in the deposition (e.g. dataset, annotation, tomogram)""", json_schema_extra = { "linkml_meta": {'alias': 'deposition_types',
         'domain_of': ['Deposition'],
...
class MicroscopeDetails(ConfiguredBaseModel):
    ...
    manufacturer: Optional[Union[MicroscopeManufacturerEnum, str]] = Field(None, description="""Name of the microscope manufacturer""", json_schema_extra = { "linkml_meta": {'alias': 'manufacturer',
         'any_of': [{'range': 'microscope_manufacturer_enum'},
...
class TiltRange(ConfiguredBaseModel):
    ...
    min: Optional[Union[float, str]] = Field(None, description="""Minimal tilt angle in degrees""", ge=-90, le=90, json_schema_extra = { "linkml_meta": {'alias': 'min',
         'any_of': [{'maximum_value': 90, 'minimum_value': -90, 'range': 'float'},
                    {'range': 'FloatFormattedString'}],
         'domain_of': ['TiltRange'],
         'unit': {'descriptive_name': 'degrees', 'symbol': '°'}} })
    max: Optional[Union[float, str]] = Field(None, description="""Maximal tilt angle in degrees""", ge=-90, le=90, json_schema_extra = { "linkml_meta": {'alias': 'max',
         'any_of': [{'maximum_value': 90, 'minimum_value': -90, 'range': 'float'},
                    {'range': 'FloatFormattedString'}],
         'domain_of': ['TiltRange'],
         'unit': {'descriptive_name': 'degrees', 'symbol': '°'}} })
...
class TiltSeries(ConfiguredBaseModel):
    ...
    aligned_tiltseries_binning: Optional[Union[float, str]] = Field(1.0, description="""Binning factor of the aligned tilt series""", ge=0, json_schema_extra = { "linkml_meta": {'alias': 'aligned_tiltseries_binning',
         'any_of': [{'minimum_value': 0, 'range': 'float'},
                    {'range': 'FloatFormattedString'}],
         'domain_of': ['TiltSeries'],
         'ifabsent': 'float(1)'} })
    ...
    spherical_aberration_constant: Optional[Union[float, str]] = Field(None, description="""Spherical Aberration Constant of the objective lens in millimeters""", ge=0, json_schema_extra = { "linkml_meta": {'alias': 'spherical_aberration_constant',
         'any_of': [{'minimum_value': 0, 'range': 'float'},
                    {'range': 'FloatFormattedString'}],
         'domain_of': ['TiltSeries'],
    ...
    tilt_axis: Optional[Union[float, str]] = Field(None, description="""Rotation angle in degrees""", ge=-360, le=360, json_schema_extra = { "linkml_meta": {'alias': 'tilt_axis',
         'any_of': [{'maximum_value': 360, 'minimum_value': -360, 'range': 'float'},
                    {'range': 'FloatFormattedString'}],
         'domain_of': ['TiltSeries'],
         'unit': {'descriptive_name': 'degrees', 'symbol': '°'}} })
    ...
    tilt_series_quality: Optional[Union[int, str]] = Field(None, description="""Author assessment of tilt series quality within the dataset (1-5, 5 is best)""", ge=1, le=5, json_schema_extra = { "linkml_meta": {'alias': 'tilt_series_quality',
         'any_of': [{'maximum_value': 5, 'minimum_value': 1, 'range': 'integer'},
                    {'range': 'IntegerFormattedString'}],
         'domain_of': ['TiltSeries']} })
    tilt_step: Optional[Union[float, str]] = Field(None, description="""Tilt step in degrees""", ge=0, le=90, json_schema_extra = { "linkml_meta": {'alias': 'tilt_step',
         'any_of': [{'maximum_value': 90, 'minimum_value': 0, 'range': 'float'},
                    {'range': 'FloatFormattedString'}],
         'domain_of': ['TiltSeries'],
         'unit': {'descriptive_name': 'degrees', 'symbol': '°'}} })
    ...
    total_flux: Optional[Union[float, str]] = Field(None, description="""Number of Electrons reaching the specimen in a square Angstrom area for the entire tilt series""", ge=0, json_schema_extra = { "linkml_meta": {'alias': 'total_flux',
         'any_of': [{'minimum_value': 0, 'range': 'float'},
                    {'range': 'FloatFormattedString'}],
         'domain_of': ['TiltSeries'],
         'unit': {'descriptive_name': 'electrons per square Angstrom',
                  'symbol': 'e^-/Å^2'}} })
    pixel_spacing: Optional[Union[float, str]] = Field(None, description="""Pixel spacing for the tilt series""", ge=0.001, json_schema_extra = { "linkml_meta": {'alias': 'pixel_spacing',
         'any_of': [{'minimum_value': 0.001, 'range': 'float'},
                    {'range': 'FloatFormattedString'}],
         'domain_of': ['TiltSeries'],
...
class Tomogram(AuthoredEntity):
    ...
    voxel_spacing: Optional[Union[float, str]] = Field(None, description="""Voxel spacing equal in all three axes in angstroms""", ge=0.001, json_schema_extra = { "linkml_meta": {'alias': 'voxel_spacing',
         'any_of': [{'minimum_value': 0.001, 'range': 'float'},
                    {'range': 'FloatFormattedString'}],
         'domain_of': ['Tomogram', 'SourceParent'],
         'unit': {'descriptive_name': 'Angstroms per voxel', 'symbol': 'Å/voxel'}} })
    fiducial_alignment_status: Optional[Union[FiducialAlignmentStatusEnum, str]] = Field(None, description="""Whether the tomographic alignment was computed based on fiducial markers.""", json_schema_extra = { "linkml_meta": {'alias': 'fiducial_alignment_status',
         'any_of': [{'range': 'fiducial_alignment_status_enum'},
                    {'range': 'StringFormattedString'}],
         'domain_of': ['Tomogram']} })
    ...
    reconstruction_method: Optional[Union[TomogromReconstructionMethodEnum, str]] = Field(None, description="""Describe reconstruction method (WBP, SART, SIRT)""", json_schema_extra = { "linkml_meta": {'alias': 'reconstruction_method',
         'any_of': [{'range': 'tomogrom_reconstruction_method_enum'},
                    {'range': 'StringFormattedString'}],
         'domain_of': ['Tomogram']} })
    ...
    affine_transformation_matrix: Optional[conlist(min_length=4, max_length=4, item_type=conlist(min_length=4, max_length=4, item_type=Any))] = Field(None, description="""A placeholder for any type of data.""", json_schema_extra = { "linkml_meta": {'alias': 'affine_transformation_matrix',
...
class AnnotationSourceFile(ConfiguredBaseModel):
    ...
    glob_strings: Optional[List[str]] = Field(default_factory=list, description="""Glob strings to match annotation files in the dataset. Required if annotation_source_file_glob_string is not provided.""", json_schema_extra = { "linkml_meta": {'alias': 'glob_strings',
         'domain_of': ['AnnotationSourceFile',
                       'AnnotationOrientedPointFile',
                       'AnnotationInstanceSegmentationFile',
                       'AnnotationPointFile',
...
class Annotation(AuthoredEntity, DatestampedEntity):
    ...
    annotation_publications: Optional[str] = Field(None, description="""List of publication IDs (EMPIAR, EMDB, DOI) that describe this annotation method. Comma separated.""", json_schema_extra = { "linkml_meta": {'alias': 'annotation_publications',
         'domain_of': ['Annotation'],
    ...
    files: Optional[List[AnnotationSourceFile]] = Field(default_factory=list, description="""File and sourcing data for an annotation. Represents an entry in annotation.sources.""", json_schema_extra = { "linkml_meta": {'alias': 'files', 'domain_of': ['Annotation'], 'list_elements_ordered': True} })
...
class AnnotationMethodLinks(ConfiguredBaseModel):
    ...
    link: str = Field(..., description="""URL to the resource""", json_schema_extra = { "linkml_meta": {'alias': 'link', 'domain_of': ['AnnotationMethodLinks']} })
    link_type: AnnotationMethodLinkTypeEnum = Field(..., description="""Type of link (e.g. model, sourcecode, documentation)""", json_schema_extra = { "linkml_meta": {'alias': 'link_type', 'domain_of': ['AnnotationMethodLinks']} })
    name: Optional[str] = Field(None, description="""user readable name of the resource""", json_schema_extra = { "linkml_meta": {'alias': 'name',
         'domain_of': ['AuthorMixin',
                       'AnnotationMethodLinks',
                       'Author',
                       'OrganismDetails',
...
class Container(ConfiguredBaseModel):
    ...
    annotations: Optional[List[AnnotationEntity]] = Field(default_factory=list, description="""An annotation entity.""", json_schema_extra = { "linkml_meta": {'alias': 'annotations', 'domain_of': ['Container']} })
    dataset_keyphotos: Optional[List[DatasetKeyPhotoEntity]] = Field(default_factory=list, description="""A dataset key photo entity.""", json_schema_extra = { "linkml_meta": {'alias': 'dataset_keyphotos', 'domain_of': ['Container']} })
    datasets: List[DatasetEntity] = Field(default_factory=list, description="""A dataset entity.""", json_schema_extra = { "linkml_meta": {'alias': 'datasets', 'domain_of': ['Container']} })
    deposition_keyphotos: Optional[List[DepositionKeyPhotoEntity]] = Field(default_factory=list, description="""A deposition key photo entity.""", json_schema_extra = { "linkml_meta": {'alias': 'deposition_keyphotos', 'domain_of': ['Container']} })
    depositions: List[DepositionEntity] = Field(default_factory=list, description="""A deposition entity.""", json_schema_extra = { "linkml_meta": {'alias': 'depositions', 'domain_of': ['Container']} })
    frames: Optional[List[FrameEntity]] = Field(default_factory=list, description="""A frame entity.""", json_schema_extra = { "linkml_meta": {'alias': 'frames', 'domain_of': ['Container']} })
    gains: Optional[List[GainEntity]] = Field(default_factory=list, description="""A gain entity.""", json_schema_extra = { "linkml_meta": {'alias': 'gains', 'domain_of': ['Container']} })
    key_images: Optional[List[KeyImageEntity]] = Field(default_factory=list, description="""A key image entity.""", json_schema_extra = { "linkml_meta": {'alias': 'key_images', 'domain_of': ['Container']} })
    rawtilts: Optional[List[RawTiltEntity]] = Field(default_factory=list, description="""A raw tilt entity.""", json_schema_extra = { "linkml_meta": {'alias': 'rawtilts', 'domain_of': ['Container']} })
    runs: Optional[List[RunEntity]] = Field(default_factory=list, description="""A run entity.""", json_schema_extra = { "linkml_meta": {'alias': 'runs', 'domain_of': ['Container']} })
    ...
    tiltseries: Optional[List[TiltSeriesEntity]] = Field(default_factory=list, description="""A tilt series entity.""", json_schema_extra = { "linkml_meta": {'alias': 'tiltseries', 'domain_of': ['Container']} })
    tomograms: Optional[List[TomogramEntity]] = Field(default_factory=list, description="""A tomogram entity.""", json_schema_extra = { "linkml_meta": {'alias': 'tomograms', 'domain_of': ['Container']} })
    voxel_spacings: List[VoxelSpacingEntity] = Field(default_factory=list, description="""A voxel spacing entity.""", json_schema_extra = { "linkml_meta": {'alias': 'voxel_spacings', 'domain_of': ['Container']} })
...
class SourceParentFiltersEntity(ConfiguredBaseModel):
    ...
    parent_filters: Optional[SourceParentFilters] = Field(None, description="""Filters for the parent of a source.""", json_schema_extra = { "linkml_meta": {'alias': 'parent_filters',
         'domain_of': ['SourceParentFiltersEntity',
                       'AnnotationSource',
                       'KeyPhotoSource',
                       'FrameSource',
                       'GainSource',
...
class SourceParentFilters(ConfiguredBaseModel):
    ...
    include: Optional[SourceParent] = Field(None, description="""A filter for a parent class of a source. For a given attribute, it can only be used if the current class is a subclass of the attribute.""", json_schema_extra = { "linkml_meta": {'alias': 'include', 'domain_of': ['SourceParentFilters']} })
    exclude: Optional[SourceParent] = Field(None, description="""A filter for a parent class of a source. For a given attribute, it can only be used if the current class is a subclass of the attribute.""", json_schema_extra = { "linkml_meta": {'alias': 'exclude', 'domain_of': ['SourceParentFilters']} })
...
class SourceParent(ConfiguredBaseModel):
    ...
    annotation: Optional[List[str]] = Field(default_factory=list, description="""Include or exclude annotations.""", json_schema_extra = { "linkml_meta": {'alias': 'annotation', 'domain_of': ['SourceParent']} })
    dataset: Optional[List[str]] = Field(default_factory=list, description="""Include or exclude datasets.""", json_schema_extra = { "linkml_meta": {'alias': 'dataset', 'domain_of': ['SourceParent']} })
    run: Optional[List[str]] = Field(default_factory=list, description="""Include or exclude runs.""", json_schema_extra = { "linkml_meta": {'alias': 'run', 'domain_of': ['SourceParent']} })
    tomogram: Optional[List[str]] = Field(default_factory=list, description="""Include or exclude tomograms.""", json_schema_extra = { "linkml_meta": {'alias': 'tomogram', 'domain_of': ['SourceParent']} })
    voxel_spacing: Optional[List[str]] = Field(default_factory=list, description="""Include or exclude voxel spacings.""", json_schema_extra = { "linkml_meta": {'alias': 'voxel_spacing', 'domain_of': ['Tomogram', 'SourceParent']} })
...
class DefaultLiteralEntity(ConfiguredBaseModel):
    ...
    literal: Optional[DefaultLiteral] = Field(None, description="""A literal class with a value attribute.""", json_schema_extra = { "linkml_meta": {'alias': 'literal',
...
class DefaultLiteral(ConfiguredBaseModel):
    ...
    value: List[Any] = Field(default_factory=list, description="""A placeholder for any type of data.""", json_schema_extra = { "linkml_meta": {'alias': 'value',
...
class KeyPhotoEntity(ConfiguredBaseModel):
    ...
    sources: List[KeyPhotoSource] = Field(default_factory=list, description="""A key photo source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['KeyPhotoEntity',
                       'AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
                       'FrameEntity',
...
class KeyPhotoSource(SourceParentFiltersEntity):
    ...
    A key photo source.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'cdp-dataset-config', 'mixins': ['SourceParentFiltersEntity']})
...
class AnnotationEntity(ConfiguredBaseModel):
    ...
    metadata: Annotation = Field(..., description="""Metadata describing an annotation.""", json_schema_extra = { "linkml_meta": {'alias': 'metadata',
         'domain_of': ['AnnotationEntity',
                       ...
                       'TiltSeriesEntity',
                       'TomogramEntity']} })
    sources: List[AnnotationSource] = Field(default_factory=list, description="""An annotation source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['KeyPhotoEntity',
                       'AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
...
class DatasetEntity(ConfiguredBaseModel):
    ...
    metadata: Dataset = Field(..., description="""High-level description of a cryoET dataset.""", json_schema_extra = { "linkml_meta": {'alias': 'metadata',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
                       'TiltSeriesEntity',
                       'TomogramEntity']} })
    sources: List[DatasetSource] = Field(default_factory=list, description="""A dataset source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['KeyPhotoEntity',
                       'AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
...
class DatasetSource(DefaultLiteralEntity, DefaultSource):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'cdp-dataset-config',
         'mixins': ['DefaultSource', 'DefaultLiteralEntity']})
...
class DepositionEntity(ConfiguredBaseModel):
    ...
    metadata: Deposition = Field(..., description="""Metadata describing a deposition.""", json_schema_extra = { "linkml_meta": {'alias': 'metadata',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
                       'TiltSeriesEntity',
                       'TomogramEntity']} })
    sources: List[DepositionSource] = Field(default_factory=list, description="""A deposition source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['KeyPhotoEntity',
                       'AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
...
class FrameEntity(ConfiguredBaseModel):
    ...
    sources: List[FrameSource] = Field(default_factory=list, description="""A frame source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['KeyPhotoEntity',
                       'AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
...
class GainEntity(ConfiguredBaseModel):
    ...
    sources: List[GainSource] = Field(default_factory=list, description="""A gain source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['KeyPhotoEntity',
                       'AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
...
class KeyImageEntity(ConfiguredBaseModel):
    ...
    sources: List[KeyImageSource] = Field(default_factory=list, description="""A key image source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['KeyPhotoEntity',
                       'AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
...
class RawTiltEntity(ConfiguredBaseModel):
    ...
    sources: List[RawTiltSource] = Field(default_factory=list, description="""A raw tilt source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['KeyPhotoEntity',
                       'AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
...
class RunEntity(ConfiguredBaseModel):
    ...
    sources: List[RunSource] = Field(default_factory=list, description="""A run source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['KeyPhotoEntity',
                       'AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
...
class TiltSeriesEntity(ConfiguredBaseModel):
    ...
    metadata: TiltSeries = Field(..., description="""Metadata describing a tilt series.""", json_schema_extra = { "linkml_meta": {'alias': 'metadata',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
                       'TiltSeriesEntity',
                       'TomogramEntity']} })
    sources: List[TiltSeriesSource] = Field(default_factory=list, description="""A tilt series source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['KeyPhotoEntity',
                       'AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
...
class TomogramEntity(ConfiguredBaseModel):
    ...
    metadata: Tomogram = Field(..., description="""Metadata describing a tomogram.""", json_schema_extra = { "linkml_meta": {'alias': 'metadata',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
                       'TiltSeriesEntity',
                       'TomogramEntity']} })
    sources: List[TomogramSource] = Field(default_factory=list, description="""A tomogram source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['KeyPhotoEntity',
                       'AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
...
class VoxelSpacingEntity(ConfiguredBaseModel):
    ...
    sources: List[VoxelSpacingSource] = Field(default_factory=list, description="""A voxel spacing source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['KeyPhotoEntity',
                       'AnnotationEntity',
                       'DatasetEntity',
                       'DepositionEntity',
