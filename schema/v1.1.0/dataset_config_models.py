...
linkml_meta = LinkMLMeta({'default_prefix': 'cdp-dataset-config/',
     ...
     'types': {'BTO_ID': {'base': 'str',
               ...
               'EMPIAR_EMDB_LIST': {'base': 'str',
                                    'description': 'A list of EMPIAR and EMDB '
                                                   'identifiers',
                                    'from_schema': 'cdp-dataset-config',
...
class MicroscopeDetails(ConfiguredBaseModel):
    ...
    manufacturer: Union[MicroscopeManufacturerEnum, str] = Field(..., description="""Name of the microscope manufacturer""", json_schema_extra = { "linkml_meta": {'alias': 'manufacturer',
         'any_of': [{'range': 'StringFormattedString'},
...
class Tomogram(AuthoredEntity):
    ...
    reconstruction_method: Union[TomogromReconstructionMethodEnum, str] = Field(..., description="""Describe reconstruction method (WBP, SART, SIRT)""", json_schema_extra = { "linkml_meta": {'alias': 'reconstruction_method',
         'any_of': [{'range': 'StringFormattedString'},
...
class Annotation(AuthoredEntity, DatestampedEntity):
    ...
    def pattern_annotation_publications(cls, v):
        pattern=re.compile(r"^(EMPIAR-[0-9]{5}|EMD-[0-9]{4,5}|(doi:)?10\.[0-9]{4,9}/[-._;()/:a-zA-Z0-9]+)(\s*,\s*(EMPIAR-[0-9]{5}|EMD-[0-9]{4,5}|(doi:)?10\.[0-9]{4,9}/[-._;()/:a-zA-Z0-9]+))*$")
        if isinstance(v,list):
            for element in v:
                if not pattern.match(element):
...
class CrossReferences(ConfiguredBaseModel):
    ...
    dataset_publications: Optional[str] = Field(None, description="""Comma-separated list of DOIs for publications associated with the dataset.""", json_schema_extra = { "linkml_meta": {'alias': 'dataset_publications',
         'domain_of': ['CrossReferences'],
         'recommended': True} })
    related_database_entries: Optional[str] = Field(None, description="""Comma-separated list of related database entries for the dataset.""", json_schema_extra = { "linkml_meta": {'alias': 'related_database_entries',
         'domain_of': ['CrossReferences'],
         'recommended': True} })
    related_database_links: Optional[str] = Field(None, description="""Comma-separated list of related database links for the dataset.""", json_schema_extra = { "linkml_meta": {'alias': 'related_database_links', 'domain_of': ['CrossReferences']} })
    dataset_citations: Optional[str] = Field(None, description="""Comma-separated list of DOIs for publications citing the dataset.""", json_schema_extra = { "linkml_meta": {'alias': 'dataset_citations', 'domain_of': ['CrossReferences']} })
    ...
    def pattern_related_database_entries(cls, v):
        pattern=re.compile(r"(^(EMPIAR-[0-9]{5}|EMD-[0-9]{4,5})(\s*,\s*(EMPIAR-[0-9]{5}|EMD-[0-9]{4,5}))*$)|(^(EMPIAR-[0-9]{5}|EMD-[0-9]{4,5})(\s*,\s*(EMPIAR-[0-9]{5}|EMD-[0-9]{4,5}))*$)")
        if isinstance(v,list):
            for element in v:
                if not pattern.match(element):
...
class Container(ConfiguredBaseModel):
    ...
    datasets: List[DatasetEntity] = Field(..., description="""A dataset entity.""", json_schema_extra = { "linkml_meta": {'alias': 'datasets', 'domain_of': ['Container']} })
    ...
    voxel_spacings: List[VoxelSpacingEntity] = Field(..., description="""A voxel spacing entity.""", json_schema_extra = { "linkml_meta": {'alias': 'voxel_spacings', 'domain_of': ['Container']} })
...
class DefaultLiteral(ConfiguredBaseModel):
    ...
    value: List[Any] = Field(..., description="""A placeholder for any type of data.""", json_schema_extra = { "linkml_meta": {'alias': 'value',
...
class AnnotationEntity(ConfiguredBaseModel):
    ...
    metadata: Annotation = Field(..., description="""Metadata describing an annotation.""", json_schema_extra = { "linkml_meta": {'alias': 'metadata',
         'domain_of': ['AnnotationEntity',
                       ...
                       'TiltSeriesEntity',
                       'TomogramEntity']} })
    sources: List[AnnotationSource] = Field(..., description="""An annotation source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
...
class DatasetEntity(ConfiguredBaseModel):
    ...
    metadata: Dataset = Field(..., description="""High-level description of a cryoET dataset.""", json_schema_extra = { "linkml_meta": {'alias': 'metadata',
         'domain_of': ['AnnotationEntity',
                       ...
                       'TiltSeriesEntity',
                       'TomogramEntity']} })
    sources: List[DatasetSource] = Field(..., description="""A dataset source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'DatasetKeyPhotoEntity',
                       'FrameEntity',
...
class DatasetKeyPhotoEntity(ConfiguredBaseModel):
    ...
    sources: List[DatasetKeyPhotoSource] = Field(..., description="""A dataset key photo source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'DatasetKeyPhotoEntity',
                       'FrameEntity',
...
class DatasetKeyPhotoSource(SourceParentFiltersEntity):
    ...
    literal: Optional[DatasetKeyPhotoLiteral] = Field(None, description="""A literal for a dataset key photo.""", json_schema_extra = { "linkml_meta": {'alias': 'literal',
         'domain_of': ['DefaultLiteralEntity',
                       'DatasetKeyPhotoSource',
                       'VoxelSpacingSource',
                       'DatasetSource',
...
class FrameEntity(ConfiguredBaseModel):
    ...
    sources: List[FrameSource] = Field(..., description="""A frame source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'DatasetKeyPhotoEntity',
                       'FrameEntity',
...
class GainEntity(ConfiguredBaseModel):
    ...
    sources: List[GainSource] = Field(..., description="""A gain source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'DatasetKeyPhotoEntity',
                       'FrameEntity',
...
class KeyImageEntity(ConfiguredBaseModel):
    ...
    sources: List[KeyImageSource] = Field(..., description="""A key image source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'DatasetKeyPhotoEntity',
                       'FrameEntity',
...
class RawTiltEntity(ConfiguredBaseModel):
    ...
    sources: List[RawTiltSource] = Field(..., description="""A raw tilt source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'DatasetKeyPhotoEntity',
                       'FrameEntity',
...
class RunEntity(ConfiguredBaseModel):
    ...
    sources: List[RunSource] = Field(..., description="""A run source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'DatasetKeyPhotoEntity',
                       'FrameEntity',
...
class TiltSeriesEntity(ConfiguredBaseModel):
    ...
    metadata: TiltSeries = Field(..., description="""Metadata describing a tilt series.""", json_schema_extra = { "linkml_meta": {'alias': 'metadata',
         'domain_of': ['AnnotationEntity',
                       ...
                       'TiltSeriesEntity',
                       'TomogramEntity']} })
    sources: List[TiltSeriesSource] = Field(..., description="""A tilt series source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'DatasetKeyPhotoEntity',
                       'FrameEntity',
...
class TomogramEntity(ConfiguredBaseModel):
    ...
    metadata: Tomogram = Field(..., description="""Metadata describing a tomogram.""", json_schema_extra = { "linkml_meta": {'alias': 'metadata',
         'domain_of': ['AnnotationEntity',
                       ...
                       'TiltSeriesEntity',
                       'TomogramEntity']} })
    sources: List[TomogramSource] = Field(..., description="""A tomogram source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'DatasetKeyPhotoEntity',
                       'FrameEntity',
...
class VoxelSpacingEntity(ConfiguredBaseModel):
    ...
    sources: List[VoxelSpacingSource] = Field(..., description="""A voxel spacing source.""", json_schema_extra = { "linkml_meta": {'alias': 'sources',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'DatasetKeyPhotoEntity',
                       'FrameEntity',
