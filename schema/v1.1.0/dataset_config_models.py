...
linkml_meta = LinkMLMeta({'default_prefix': 'cdp-dataset-config-validate/',
...
class TiltSeries(ConfiguredBaseModel):
    ...
    camera: Camera = Field(..., description="""The camera used to collect the tilt series.""", json_schema_extra = { "linkml_meta": {'alias': 'camera', 'domain_of': ['TiltSeries']} })
...
class Tomogram(AuthoredEntity):
    ...
    reconstruction_method: str = Field(..., description="""Describe reconstruction method (Weighted back-projection, SART, SIRT)""", json_schema_extra = { "linkml_meta": {'alias': 'reconstruction_method',
         'domain_of': ['Tomogram'],
    ...
    processing: str = Field(..., description="""Describe additional processing used to derive the tomogram""", json_schema_extra = { "linkml_meta": {'alias': 'processing',
         'domain_of': ['Tomogram'],
...
class GeneralGlob(ConfiguredBaseModel):
    ...
    list_glob: str = Field(..., description="""The glob for the file.""", json_schema_extra = { "linkml_meta": {'alias': 'list_glob', 'domain_of': ['GeneralGlob', 'TomogramHeader']} })
...
class DefaultSource(ConfiguredBaseModel):
    ...
    destination_glob: Optional[DestinationGlob] = Field(None, description="""The glob object for the destination file.""", json_schema_extra = { "linkml_meta": {'alias': 'destination_glob',
         'domain_of': ['DefaultSource', 'VoxelSpacingSource']} })
    source_glob: Optional[SourceGlob] = Field(None, description="""The glob object for the source file.""", json_schema_extra = { "linkml_meta": {'alias': 'source_glob', 'domain_of': ['DefaultSource', 'VoxelSpacingSource']} })
    source_multi_glob: Optional[SourceMultiGlob] = Field(None, description="""The glob object for the source file (with multiple globs).""", json_schema_extra = { "linkml_meta": {'alias': 'source_multi_glob', 'domain_of': ['DefaultSource']} })
...
class SourceParentFilters(ConfiguredBaseModel):
    ...
    include: Optional[SourceParent] = Field(None, description="""Include files for the parent of a source (regexes).""", json_schema_extra = { "linkml_meta": {'alias': 'include', 'domain_of': ['SourceParentFilters']} })
    exclude: Optional[SourceParent] = Field(None, description="""Exclude files for the parent of a source (regexes).""", json_schema_extra = { "linkml_meta": {'alias': 'exclude', 'domain_of': ['SourceParentFilters']} })
...
class AnnotationEntity(ConfiguredBaseModel):
    ...
    metadata: Annotation = Field(..., description="""The metadata for the annotation.""", json_schema_extra = { "linkml_meta": {'alias': 'metadata',
...
class DatasetEntity(ConfiguredBaseModel):
    ...
    metadata: Dataset = Field(..., json_schema_extra = { "linkml_meta": {'alias': 'metadata',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'TiltSeriesEntity',
                       'TomogramEntity']} })
...
class DatasetKeyPhotoLiteral(ConfiguredBaseModel):
    ...
    value: PicturePath = Field(..., description="""The value for the dataset key photo literal.""", json_schema_extra = { "linkml_meta": {'alias': 'value',
         'domain_of': ['DefaultLiteral',
                       'DatasetKeyPhotoLiteral',
                       'VoxelSpacingLiteral']} })
...
class TiltSeriesEntity(ConfiguredBaseModel):
    ...
    metadata: TiltSeries = Field(..., json_schema_extra = { "linkml_meta": {'alias': 'metadata',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'TiltSeriesEntity',
                       'TomogramEntity']} })
...
class TomogramEntity(ConfiguredBaseModel):
    ...
    metadata: Tomogram = Field(..., json_schema_extra = { "linkml_meta": {'alias': 'metadata',
         'domain_of': ['AnnotationEntity',
                       'DatasetEntity',
                       'TiltSeriesEntity',
                       'TomogramEntity']} })
...
class VoxelSpacingSource(SourceParentFiltersEntity):
    ...
    destination_glob: Optional[DestinationGlob] = Field(None, description="""The glob object for the destination file.""", json_schema_extra = { "linkml_meta": {'alias': 'destination_glob',
         'domain_of': ['DefaultSource', 'VoxelSpacingSource']} })
    source_glob: Optional[SourceGlob] = Field(None, description="""The glob object for the source file.""", json_schema_extra = { "linkml_meta": {'alias': 'source_glob', 'domain_of': ['DefaultSource', 'VoxelSpacingSource']} })
    literal: Optional[VoxelSpacingLiteral] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'literal',
         'domain_of': ['DefaultLiteralEntity',
                       'DatasetKeyPhotoSource',
                       'VoxelSpacingSource']} })
    tomogram_header: Optional[TomogramHeader] = Field(None, description="""The header for the voxel spacing.""", json_schema_extra = { "linkml_meta": {'alias': 'tomogram_header', 'domain_of': ['VoxelSpacingSource']} })
    parent_filters: Optional[SourceParentFilters] = Field(None, description="""Filters for the parent of a source.""", json_schema_extra = { "linkml_meta": {'alias': 'parent_filters',
         'domain_of': ['SourceParentFiltersEntity', 'AnnotationSource']} })
...
class TomogramHeader(ConfiguredBaseModel):
    ...
    list_glob: str = Field(..., description="""The glob for the tomogram header file.""", json_schema_extra = { "linkml_meta": {'alias': 'list_glob', 'domain_of': ['GeneralGlob', 'TomogramHeader']} })
...
class Container(ConfiguredBaseModel):
    ...
    rawtilts: Optional[List[RawTiltEntity]] = Field(default_factory=list, description="""Raw tilts for the dataset.""", json_schema_extra = { "linkml_meta": {'alias': 'rawtilts', 'domain_of': ['Container']} })
    runs: Optional[List[RunEntity]] = Field(default_factory=list, description="""Runs for the dataset.""", json_schema_extra = { "linkml_meta": {'alias': 'runs', 'domain_of': ['Container']} })
