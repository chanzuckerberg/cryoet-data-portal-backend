...
class AnnotationSource(DefaultSource):
    ...
    InstanceSegmentationMask: Optional[AnnotationInstanceSegmentationMaskFile] = Field(None, description="""File and sourcing data for an instance segmentation annotation mask. Annotation that identifies individual instances of object shape masks.""", json_schema_extra = { "linkml_meta": {'alias': 'InstanceSegmentationMask', 'domain_of': ['AnnotationSource']} })
