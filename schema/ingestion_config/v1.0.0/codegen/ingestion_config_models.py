...
class MicroscopeDetails(ConfiguredBaseModel):
    ...
    manufacturer: Optional[Union[TiltseriesMicroscopeManufacturerEnum, str]] = Field(None, description="""Name of the microscope manufacturer""", json_schema_extra = { "linkml_meta": {'alias': 'manufacturer',
         'any_of': [{'range': 'tiltseries_microscope_manufacturer_enum'},
...
class Tomogram(AuthoredEntity):
    ...
    reconstruction_method: Optional[Union[TomogramReconstructionMethodEnum, str]] = Field(None, description="""Describe reconstruction method (WBP, SART, SIRT)""", json_schema_extra = { "linkml_meta": {'alias': 'reconstruction_method',
         'any_of': [{'range': 'tomogram_reconstruction_method_enum'},
                    {'range': 'StringFormattedString'}],
         'domain_of': ['Tomogram']} })
