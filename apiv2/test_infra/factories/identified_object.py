"""
Factory for generating IdentifiedObject objects.
...
import factory
from database.models import IdentifiedObject
...
class IdentifiedObjectFactory(CommonFactory):
    class Meta:
        sqlalchemy_session = None  # workaround for a bug in factoryboy
        model = IdentifiedObject
