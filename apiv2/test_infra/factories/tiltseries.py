...
class TiltseriesFactory(CommonFactory):
    ...
    https_mrc_bin1 = fuzzy.FuzzyText()
    s3_collection_metadata = fuzzy.FuzzyText()
    https_collection_metadata = fuzzy.FuzzyText()
    ...
    aligned_tiltseries_binning = fuzzy.FuzzyFloat(1, 100)
