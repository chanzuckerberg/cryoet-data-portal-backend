...
class RunUpdateInput:
    dataset_id: Optional[strawberry.ID] = strawberry.field(
        description="Dataset that this run is a part of", default=None,
    )
    name: Optional[str] = strawberry.field(description="Short name for this experiment run", default=None)
    s3_prefix: Optional[str] = strawberry.field(
        description="The S3 public bucket path where this run is contained", default=None,
    )
    https_prefix: Optional[str] = strawberry.field(
        description="The HTTPS directory path where this run is contained url", default=None,
    )
