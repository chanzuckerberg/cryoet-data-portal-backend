...
class TomogramVoxelSpacingUpdateInput:
    ...
    voxel_spacing: Optional[float] = strawberry.field(
        description="The voxel spacing for the tomograms in this set in angstroms", default=None,
    )
    s3_prefix: Optional[str] = strawberry.field(
        description="The S3 public bucket path where this tomogram voxel spacing is contained", default=None,
    )
    https_prefix: Optional[str] = strawberry.field(
        description="The HTTPS directory path where this tomogram voxel spacing is contained", default=None,
    )
