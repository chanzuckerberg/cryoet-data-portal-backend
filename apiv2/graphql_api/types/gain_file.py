...
class GainFileUpdateInput:
    ...
    s3_file_path: Optional[str] = strawberry.field(description="Path to the file in s3", default=None)
    https_file_path: Optional[str] = strawberry.field(description="Path to the file as an https url", default=None)
