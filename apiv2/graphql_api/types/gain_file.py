...
from validators.gain_file import GainFileCreateInputValidator
from validators.gain_file import GainFileUpdateInputValidator
    ...
    for key, value in row.items():
        ...
        if aggregate[0] not in aggregator_map.keys():
            ...
            if not getattr(output, "groupBy"):
                setattr(output, "groupBy", GainFileGroupByOptions())
            group = build_gain_file_groupby_output(getattr(output, "groupBy"), group_keys, value)
