...
class AnnotationFileUpdateInput:
    ...
    format: Optional[str] = strawberry.field(description="File format for this file", default=None)
    s3_path: Optional[str] = strawberry.field(description="s3 path of the annotation file", default=None)
    file_size: Optional[float] = strawberry.field(description="Size of annota file in bytes", default=None)
    https_path: Optional[str] = strawberry.field(description="HTTPS path for this annotation file", default=None)
    is_visualization_default: Optional[bool] = strawberry.field(
        description="Data curator’s subjective choice of default annotation to display in visualization for an object",
        default=None,
    )
