...
@relay.connection(relay.ListConnection[Annotated["Run", strawberry.lazy("graphql_api.types.run")]])  # type: ignore
...
class Dataset(EntityInterface):
    ...
    development_stage_ontology_id: Optional[str] = strawberry.field(
        description="Ontology identifier for the development stage",
        default=None,
    )
