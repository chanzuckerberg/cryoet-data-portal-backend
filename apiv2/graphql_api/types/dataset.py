...
class DatasetUpdateInput:
    ...
    title: Optional[str] = strawberry.field(description="Title of a CryoET dataset", default=None)
    ...
    deposition_date: Optional[datetime.datetime] = strawberry.field(
        description="Date when a dataset is initially received by the Data Portal.", default=None,
    )
    release_date: Optional[datetime.datetime] = strawberry.field(
        description="Date when a dataset is made available on the Data Portal.", default=None,
    )
    last_modified_date: Optional[datetime.datetime] = strawberry.field(
        description="Date when a released dataset is last modified.", default=None,
    )
    dataset_publications: Optional[str] = strawberry.field(
        description="Comma-separated list of DOIs for publications associated with the dataset.", default=None,
    )
    ...
    s3_prefix: Optional[str] = strawberry.field(
        description="The S3 public bucket path where this dataset is contained", default=None,
    )
    https_prefix: Optional[str] = strawberry.field(
        description="The https directory path where this dataset is contained", default=None,
    )
    file_size: Optional[float] = strawberry.field(description="Size of the dataset in bytes", default=None)
