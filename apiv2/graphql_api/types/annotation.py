...
class AnnotationUpdateInput:
    ...
    s3_metadata_path: Optional[str] = strawberry.field(
        description="S3 path for the metadata json file for this annotation", default=None,
    )
    https_metadata_path: Optional[str] = strawberry.field(
        description="HTTPS path for the metadata json file for this annotation", default=None,
    )
    annotation_publication: Optional[str] = strawberry.field(
        description="DOIs for publications that describe the dataset. Use a comma to separate multiple DOIs.",
        default=None,
    ...
    method_type: Optional[annotation_method_type_enum] = strawberry.field(
        description="The method type for generating the annotation (e.g. manual, hybrid, automated)", default=None,
    )
    deposition_date: Optional[datetime.datetime] = strawberry.field(
        description="Date when an annotation set is initially received by the Data Portal.", default=None,
    )
    release_date: Optional[datetime.datetime] = strawberry.field(
        description="Date when annotation data is made public by the Data Portal.", default=None,
    )
    last_modified_date: Optional[datetime.datetime] = strawberry.field(
        description="Date when an annotation was last modified in the Data Portal", default=None,
    )
