...
class TiltseriesUpdateInput:
    ...
    acceleration_voltage: Optional[int] = strawberry.field(
        description="Electron Microscope Accelerator voltage in volts", default=None,
    )
    spherical_aberration_constant: Optional[float] = strawberry.field(
        description="Spherical Aberration Constant of the objective lens in millimeters", default=None,
    )
    microscope_manufacturer: Optional[tiltseries_microscope_manufacturer_enum] = strawberry.field(
        description="Name of the microscope manufacturer (FEI, TFS, JEOL)", default=None,
    )
    microscope_model: Optional[str] = strawberry.field(description="Microscope model name", default=None)
    microscope_energy_filter: Optional[str] = strawberry.field(description="Energy filter setup used", default=None)
    microscope_phase_plate: Optional[str] = strawberry.field(description="Phase plate configuration", default=None)
    microscope_image_corrector: Optional[str] = strawberry.field(description="Image corrector setup", default=None)
    microscope_additional_info: Optional[str] = strawberry.field(
        description="Other microscope optical setup information, in addition to energy filter, phase plate and image corrector",
    ...
    camera_manufacturer: Optional[str] = strawberry.field(description="Name of the camera manufacturer", default=None)
    camera_model: Optional[str] = strawberry.field(description="Camera model name", default=None)
    tilt_min: Optional[float] = strawberry.field(description="Minimal tilt angle in degrees", default=None)
    tilt_max: Optional[float] = strawberry.field(description="Maximal tilt angle in degrees", default=None)
    tilt_range: Optional[float] = strawberry.field(description="Total tilt range in degrees", default=None)
    tilt_step: Optional[float] = strawberry.field(description="Tilt step in degrees", default=None)
    tilting_scheme: Optional[str] = strawberry.field(
        description="The order of stage tilting during acquisition of the data", default=None,
    )
    tilt_axis: Optional[float] = strawberry.field(description="Rotation angle in degrees", default=None)
    total_flux: Optional[float] = strawberry.field(
        description="Number of Electrons reaching the specimen in a square Angstrom area for the entire tilt series",
        default=None,
    )
    data_acquisition_software: Optional[str] = strawberry.field(
        description="Software used to collect data", default=None,
    )
    related_empiar_entry: Optional[str] = strawberry.field(
        description="If a tilt series is deposited into EMPIAR, enter the EMPIAR dataset identifier", default=None,
    )
    ...
    tilt_series_quality: Optional[int] = strawberry.field(
        description="Author assessment of tilt series quality within the dataset (1-5, 5 is best)", default=None,
    )
    is_aligned: Optional[bool] = strawberry.field(description="Whether this tilt series is aligned", default=None)
    pixel_spacing: Optional[float] = strawberry.field(
        description="Pixel spacing equal in both axes in angstroms", default=None,
    )
    aligned_tiltseries_binning: Optional[int] = strawberry.field(
        description="Binning factor of the aligned tilt series", default=None,
    )
