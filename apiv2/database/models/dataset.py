...
class Dataset(Base):
    ...
    assay_label: Mapped[str] = mapped_column(String, nullable=True)
    assay_ontology_id: Mapped[str] = mapped_column(String, nullable=True)
    development_stage_name: Mapped[str] = mapped_column(String, nullable=True)
    development_stage_ontology_id: Mapped[str] = mapped_column(String, nullable=True)
    disease_name: Mapped[str] = mapped_column(String, nullable=True)
    disease_ontology_id: Mapped[str] = mapped_column(String, nullable=True)
