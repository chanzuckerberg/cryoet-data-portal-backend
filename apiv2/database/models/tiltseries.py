...
class Tiltseries(Base):
    ...
    microscope_manufacturer: Mapped[tiltseries_microscope_manufacturer_enum] = mapped_column(Enum(tiltseries_microscope_manufacturer_enum, native_enum=False), nullable=False)
