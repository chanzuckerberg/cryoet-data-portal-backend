...
class Tomogram(Base):
    ...
    fiducial_alignment_status: Mapped[fiducial_alignment_status_enum] = mapped_column(Enum(fiducial_alignment_status_enum, native_enum=False), nullable=False)
    reconstruction_method: Mapped[tomogram_reconstruction_method_enum] = mapped_column(Enum(tomogram_reconstruction_method_enum, native_enum=False), nullable=False)
    processing: Mapped[tomogram_processing_enum] = mapped_column(Enum(tomogram_processing_enum, native_enum=False), nullable=False)
