...
class Tomogram(Base):
    ...
    is_author_submitted: Mapped[bool] = mapped_column(Boolean, nullable=True, server_default="False")
    is_visualization_default: Mapped[bool] = mapped_column(Boolean, nullable=True, server_default="False")
