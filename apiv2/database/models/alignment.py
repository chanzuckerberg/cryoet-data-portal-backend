...
class Alignment(Base):
    ...
    tiltseries_id: Mapped[int] = mapped_column(
        Integer,
        ForeignKey("tiltseries.id"),
        nullable=True, index=True,
    )
    ...
    alignment_type: Mapped[alignment_type_enum] = mapped_column(Enum(alignment_type_enum, native_enum=False), nullable=True)
    alignment_method: Mapped[alignment_method_type_enum] = mapped_column(Enum(alignment_method_type_enum, native_enum=False), nullable=True)
