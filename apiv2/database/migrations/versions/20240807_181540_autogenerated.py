...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('SUCCESS', 'FAILED', 'PENDING', name='filestatus', native_enum=False), nullable=False),
    ...
    sa.Column('upload_client', sa.Enum('browser', 'cli', 's3', 'basespace', name='fileuploadclient', native_enum=False), nullable=True),
    ...
    sa.Column('sample_type', sa.Enum('cell', 'tissue', 'organism', 'organelle', 'virus', 'in_vitro', 'in_silico', 'other', name='sample_type_enum', native_enum=False), nullable=True),
    ...
    op.create_table('deposition_author',
    sa.Column('deposition_id', sa.Integer(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['deposition_id'], ['deposition.id'], name=op.f('fk_deposition_author_deposition_id_deposition')),
    ...
    op.create_table('deposition_type',
    sa.Column('deposition_id', sa.Integer(), nullable=True),
    sa.Column('type', sa.Enum('annotation', 'dataset', 'tomogram', name='deposition_types_enum', native_enum=False), nullable=True),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['deposition_id'], ['deposition.id'], name=op.f('fk_deposition_type_deposition_id_deposition')),
    ...
    op.create_table('dataset_author',
    ...
    op.create_table('dataset_funding',
    sa.Column('dataset_id', sa.Integer(), nullable=True),
    ...
    sa.Column('method_type', sa.Enum('manual', 'automated', 'hybrid', name='annotation_method_type_enum', native_enum=False), nullable=False),
    sa.Column('deposition_date', sa.DateTime(timezone=True), nullable=False),
    sa.Column('release_date', sa.DateTime(timezone=True), nullable=False),
    sa.Column('last_modified_date', sa.DateTime(timezone=True), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['deposition_id'], ['deposition.id'], name=op.f('fk_annotation_deposition_id_deposition')),
    ...
    sa.Column('microscope_manufacturer', sa.Enum('FEI', 'TFS', 'JEOL', name='tiltseries_microscope_manufacturer_enum', native_enum=False), nullable=False),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['deposition_id'], ['deposition.id'], name=op.f('fk_tiltseries_deposition_id_deposition')),
    ...
    op.create_table('tomogram_voxel_spacing',
    sa.Column('run_id', sa.Integer(), nullable=True),
    ...
    sa.Column('alignment_type', sa.Enum('LOCAL', 'GLOBAL', name='alignment_type_enum', native_enum=False), nullable=True),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['deposition_id'], ['deposition.id'], name=op.f('fk_alignment_deposition_id_deposition')),
    sa.ForeignKeyConstraint(['run_id'], ['run.id'], name=op.f('fk_alignment_run_id_run')),
    sa.ForeignKeyConstraint(['tiltseries_id'], ['tiltseries.id'], name=op.f('fk_alignment_tiltseries_id_tiltseries')),
    ...
    op.create_table('annotation_author',
    ...
    sa.Column('primary_author_status', sa.Boolean(), nullable=True),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['annotation_id'], ['annotation.id'], name=op.f('fk_annotation_author_annotation_id_annotation')),
    ...
    op.create_table('annotation_shape',
    sa.Column('annotation_id', sa.Integer(), nullable=True),
    sa.Column('shape_type', sa.Enum('SegmentationMask', 'OrientedPoint', 'Point', 'InstanceSegmentation', name='annotation_file_shape_type_enum', native_enum=False), nullable=True),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['annotation_id'], ['annotation.id'], name=op.f('fk_annotation_shape_annotation_id_annotation')),
    ...
    op.create_table('annotation_file',
    ...
    sa.Column('source', sa.Enum('dataset_author', 'community', 'portal_standard', name='annotation_file_source_enum', native_enum=False), nullable=True),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['alignment_id'], ['alignment.id'], name=op.f('fk_annotation_file_alignment_id_alignment')),
    sa.ForeignKeyConstraint(['annotation_shape_id'], ['annotation_shape.id'], name=op.f('fk_annotation_file_annotation_shape_id_annotation_shape')),
    sa.ForeignKeyConstraint(['tomogram_voxel_spacing_id'], ['tomogram_voxel_spacing.id'], name=op.f('fk_annotation_file_tomogram_voxel_spacing_id_tomogram_voxel_spacing')),
    ...
    op.create_index(op.f('ix_annotation_file_annotation_shape_id'), 'annotation_file', ['annotation_shape_id'], unique=False)
    op.create_index(op.f('ix_annotation_file_id'), 'annotation_file', ['id'], unique=False)
    op.create_index(op.f('ix_annotation_file_tomogram_voxel_spacing_id'), 'annotation_file', ['tomogram_voxel_spacing_id'], unique=False)
    op.create_table('per_section_alignment_parameters',
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['alignment_id'], ['alignment.id'], name=op.f('fk_per_section_alignment_parameters_alignment_id_alignment')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_per_section_alignment_parameters'))
    )
    op.create_index(op.f('ix_per_section_alignment_parameters_alignment_id'), 'per_section_alignment_parameters', ['alignment_id'], unique=False)
    op.create_index(op.f('ix_per_section_alignment_parameters_id'), 'per_section_alignment_parameters', ['id'], unique=False)
    op.create_table('tomogram',
    sa.Column('alignment_id', sa.Integer(), nullable=True),
    sa.Column('deposition_id', sa.Integer(), nullable=True),
    sa.Column('run_id', sa.Integer(), nullable=True),
    sa.Column('tomogram_voxel_spacing_id', sa.Integer(), nullable=True),
    ...
    sa.Column('voxel_spacing', sa.Float(), nullable=False),
    sa.Column('fiducial_alignment_status', sa.Enum('FIDUCIAL', 'NON_FIDUCIAL', name='fiducial_alignment_status_enum', native_enum=False), nullable=False),
    sa.Column('reconstruction_method', sa.Enum('SART', 'Fourier_Space', 'SIRT', 'WBP', 'Unknown', name='tomogram_reconstruction_method_enum', native_enum=False), nullable=False),
    sa.Column('processing', sa.Enum('denoised', 'filtered', 'raw', name='tomogram_processing_enum', native_enum=False), nullable=False),
    ...
    sa.Column('tomogram_type', sa.Enum('CANONICAL', 'UNKNOWN', name='tomogram_type_enum', native_enum=False), nullable=True),
    ...
    sa.ForeignKeyConstraint(['deposition_id'], ['deposition.id'], name=op.f('fk_tomogram_deposition_id_deposition')),
    sa.ForeignKeyConstraint(['run_id'], ['run.id'], name=op.f('fk_tomogram_run_id_run')),
    sa.ForeignKeyConstraint(['tomogram_voxel_spacing_id'], ['tomogram_voxel_spacing.id'], name=op.f('fk_tomogram_tomogram_voxel_spacing_id_tomogram_voxel_spacing')),
    ...
    op.create_index(op.f('ix_tomogram_tomogram_voxel_spacing_id'), 'tomogram', ['tomogram_voxel_spacing_id'], unique=False)
    op.create_table('tomogram_author',
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_per_section_alignment_parameters_alignment_id'), table_name='per_section_alignment_parameters')
