...
Create Date: 2024-08-07 16:29:10.672043
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("tissue_name", sa.String(), nullable=False),
        ...
        sa.Column("cell_strain_name", sa.String(), nullable=False),
        ...
        sa.Column("cell_component_name", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("spherical_abberation_constant", sa.Float(), nullable=False),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column("type", sa.Enum("CANONICAL", "UNKNOWN", name="tomogram_type", native_enum=False), nullable=True),
