...
class TomogramCreateInputValidator(BaseModel):
    ...
    size_x: Annotated[ int, Field(
    ge=0)]
    size_y: Annotated[ int, Field(
    ge=0)]
    size_z: Annotated[ int, Field(
    ge=0)]
    ...
    processing_software: Annotated[ str | None, StringConstraints(strip_whitespace=True)]
    reconstruction_software: Annotated[ str, StringConstraints(strip_whitespace=True)]
    ...
    scale0_dimensions: Annotated[ str | None, StringConstraints(strip_whitespace=True)]
    scale1_dimensions: Annotated[ str | None, StringConstraints(strip_whitespace=True)]
    scale2_dimensions: Annotated[ str | None, StringConstraints(strip_whitespace=True)]
    ...
    neuroglancer_config: Annotated[ str | None, StringConstraints(strip_whitespace=True)]
    publications: Annotated[ str | None, StringConstraints(strip_whitespace=True,
...
class TomogramUpdateInputValidator(BaseModel):
    ...
    tomogram_version: Annotated[ float | None, Field()]
    processing_software: Annotated[ str | None, StringConstraints(strip_whitespace=True)]
    reconstruction_software: Annotated[ str | None, StringConstraints(strip_whitespace=True)]
    is_portal_standard: Annotated[ bool | None, Field()]
    is_author_submitted: Annotated[ bool | None, Field()]
    is_visualization_default: Annotated[ bool | None, Field()]
    s3_omezarr_dir: Annotated[ str | None, StringConstraints(strip_whitespace=True)]
