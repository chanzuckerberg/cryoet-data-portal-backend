...
class AnnotationFileCreateInputValidator(BaseModel):
    ...
    format: Annotated[ str, StringConstraints(strip_whitespace=True)]
    s3_path: Annotated[ str, StringConstraints(strip_whitespace=True)]
    file_size: Annotated[ float | None, Field()]
    https_path: Annotated[ str, StringConstraints(strip_whitespace=True)]
...
class AnnotationFileUpdateInputValidator(BaseModel):
    ...
    annotation_shape_id: Annotated[ uuid.UUID | None, Field()]
    tomogram_voxel_spacing_id: Annotated[ uuid.UUID | None, Field()]
    format: Annotated[ str | None, StringConstraints(strip_whitespace=True)]
    s3_path: Annotated[ str | None, StringConstraints(strip_whitespace=True)]
    file_size: Annotated[ float | None, Field()]
    https_path: Annotated[ str | None, StringConstraints(strip_whitespace=True)]
    is_visualization_default: Annotated[ bool | None, Field()]
    source: Annotated[ annotation_file_source_enum | None, Field()]
