...
class AlignmentCreateInputValidator(BaseModel):
    ...
    affine_transformation_matrix: Annotated[ str | None, StringConstraints(strip_whitespace=True)]
    s3_alignment_metadata: Annotated[ str | None, StringConstraints(strip_whitespace=True)]
    https_alignment_metadata: Annotated[ str | None, StringConstraints(strip_whitespace=True)]
