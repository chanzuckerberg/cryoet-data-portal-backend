"""
Pydantic validator for SystemWritableOnlyType
...
class SystemWritableOnlyTypeCreateInputValidator(BaseModel):
    # Pydantic stuff
...
class SystemWritableOnlyTypeUpdateInputValidator(BaseModel):
    # Pydantic stuff
    model_config = ConfigDict(from_attributes=True)
    name: Annotated[
        str | None,
