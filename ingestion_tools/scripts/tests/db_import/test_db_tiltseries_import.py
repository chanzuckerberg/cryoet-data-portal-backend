    ...
    return [
        {
            ...
            "s3_collection_metadata": f"s3://test-public-bucket/{DATASET_ID}/RUN1/Frames/foo.mdoc",
            "https_collection_metadata": f"{http_prefix}/{DATASET_ID}/RUN1/Frames/foo.mdoc",
            ...
            "s3_alignment_file": f"s3://test-public-bucket/{DATASET_ID}/RUN1/Alignments/100/baz.xf",
            "https_alignment_file": f"{http_prefix}/{DATASET_ID}/RUN1/Alignments/100/baz.xf",
