    ...
    return [
        {
            "id": TILTSERIES_ID,
            "run_id": RUN1_ID,
            "s3_mrc_bin1": f"s3://test-public-bucket/{DATASET_ID}/RUN1/TiltSeries/100/ts_foo.mrc",
            "https_mrc_bin1": f"{http_prefix}/{DATASET_ID}/RUN1/TiltSeries/100/ts_foo.mrc",
            ...
            "s3_collection_metadata": f"s3://test-public-bucket/{DATASET_ID}/RUN1/TiltSeries/100/foo.mdoc",
            "https_collection_metadata": f"{http_prefix}/{DATASET_ID}/RUN1/TiltSeries/100/foo.mdoc",
            ...
            "s3_alignment_file": f"s3://test-public-bucket/{DATASET_ID}/RUN1/TiltSeries/100/baz.xf",
            "https_alignment_file": f"{http_prefix}/{DATASET_ID}/RUN1/TiltSeries/100/baz.xf",
        ...
        {
            "s3_mrc_bin1": f"s3://test-public-bucket/{DATASET_ID}/RUN3/TiltSeries/100/ts_foo.mrc",
            "https_mrc_bin1": f"{http_prefix}/{DATASET_ID}/RUN3/TiltSeries/100/ts_foo.mrc",
